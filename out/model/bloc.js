...
class Bloc {
    ...
    getBlocFiles(rootPath) {
        let r = [];
        r.push(new bloc_file_1.BlocFile(this.toPathName(rootPath, this.blocFileName), content_function_1.getBlocContent(this)));
        r.push(new bloc_file_1.BlocFile(this.toPathName(rootPath, this.eventFileName), content_function_1.getBlocEventContent(this)));
        r.push(new bloc_file_1.BlocFile(this.toPathName(rootPath, this.stateFileName), content_function_1.getBlocStateContent(this)));
        return r;
    }
    toFileName(name) {
        return name + ".dart";
